...
export default () => {
  ...
  const cards = [
    {title: "App Design", icon: MobileApp},
    {title: "Web Design", icon: ReactJSIcon},
    {title: "Desktop Design", icon: LaptopLogo},
  ].map((element) => {
    return (
      <Grid item xs>
  ...
  const cards2 = [
    {title: "Bot Design", icon: BotIcon},
    {title: "AI Design", icon: VanillaLogo},
    {title: "Embedded Design", icon: LaptopLogo},
  ].map((element) => {
    return (
      <Grid item xs>
        <Card className={styles.cardStyle}>
